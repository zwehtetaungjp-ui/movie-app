...
ad_link = "https://သင့်ရဲ့_smart_link_ဒီမှာထည့်"

# ၂။ မူရင်း Video Link (ဒီမှာ ရုပ်ရှင် Link အစစ်ကို ထည့်ပါ)
video_link = "https://သင့်ရဲ့_video_link_အစစ်_ဒီမှာထည့်"
...
if st.button("🚀 Watch Full Movie Now"):
    ...
    st.markdown(f"### [၁။ ဒီနေရာကိုနှိပ်ပြီး ကြော်ငြာကျော်ပါ]({https://www.effectivegatecpm.com/qibbz5efk?key=5f2f2e515dea23a4c38d317bca6b11c7})")
    ...
    st.markdown(f"*[၂။ ရုပ်ရှင်ကြည့်ရန် ဤနေရာကိုနှိပ်ပါ]({https://sl1nk.com/wVO8S})*")
